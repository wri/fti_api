...
ActiveRecord::Schema.define(version: 20220731133019) do
ActiveRecord::Schema.define(version: 20220803123657) do
  ...
  create_table "score_operator_observations", force: :cascade do |t|
    ...
    t.index ["operator_id", "current"], name: "index_score_operator_observations_on_operator_id_and_current", unique: true, where: "current", using: :btree
