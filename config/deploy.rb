...
# set :default_env, {
#   "PATH" => "#{rvm_path}/gems/ruby-#{ruby_version}/bin:#{rvm_path}/bin:$PATH",
#   "RUBY_VERSION" => "ruby-#{ruby_version}",
#   "GEM_HOME" => "#{rvm_path}/gems/ruby-#{ruby_version}",
#   "GEM_PATH" => "#{rvm_path}/gems/ruby-#{ruby_version}",
#   "BUNDLE_PATH" => "#{rvm_path}/gems/ruby-#{ruby_version}"
# }
...
set :service_unit_env_vars, %w[RAILS_ENV=staging]
