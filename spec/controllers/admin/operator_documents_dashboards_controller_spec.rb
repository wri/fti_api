...
RSpec.describe Admin::ProducerDocumentsDashboardsController, type: :controller do
  ...
  describe "GET index with more rows than a page" do
    before do
      OperatorDocumentStatistic.generate_for_country_and_day(nil, 3.days.ago.to_date, true)
      OperatorDocumentStatistic.generate_for_country_and_day(nil, 2.days.ago.to_date, true)
