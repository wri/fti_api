...
namespace :translations do
  ...
  desc 'Translated all fields'
  task french: :environment do
    Rails.logger.info '::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::'
    Rails.logger.info "Going to translate to French at: #{Time.now.strftime('%d/%m/%Y %H:%M')}"
    ...
    Rails.logger.info "Translated to french. It took #{time} ms."
    Rails.logger.info '::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::'
  end
end