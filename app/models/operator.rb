...
class Operator < ApplicationRecord
  ...
  def percentage_non_approved
    ...
    self.percentage_valid_documents_country =
      operator_document_countries.valid.available.count.to_f / operator_document_countries.required.joins(:required_operator_document).count.to_f rescue 0
  end
  ...
  def percentage_approved
    ...
    self.percentage_valid_documents_country =
      operator_document_countries.valid.count.to_f / operator_document_countries.required.joins(:required_operator_document).count.to_f rescue 0
  end
