    ...
    panel "Visible columns" do
      render partial: "fields", locals: {
        ...
        attributes: [
          ...
          ["observation_type", Observation.human_attribute_name(:observation_type)],
          ["operator", I18n.t("activerecord.models.operator")],
          ["fmu_forest_type", ObservationHistory.human_attribute_name(:fmu_forest_type)],
          ["severity_level", Severity.human_attribute_name(:level)],
